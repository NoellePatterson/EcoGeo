...
start_day = pd.to_datetime("1988-10-1")
end_day = pd.to_datetime("2020-01-01")
num_days = (end_day-start_day).days
datelist = pd.date_range(end=pd.datetime.today(), periods=num_days).tolist()
station_id = "11525500"
param_id = "00060"
...
# set parameters, Jensen
# start_day = pd.to_datetime("1946-10-1")
# end_day = pd.to_datetime("2019-06-03")
# num_days = (end_day-start_day).days
# datelist = pd.date_range(end=pd.datetime.today(), periods=num_days).tolist()
# station_id = "09261000"
# param_id = "00060"
...
flow_csv[['date','flow']].to_csv("Lewiston.csv", sep=',', index=False)
